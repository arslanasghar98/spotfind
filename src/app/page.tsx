...
import { useEnterSubmit } from "@/lib/user-enter-submit";
...
export default function Home() {
  ...
  return (
    <main>
      <div className="fixed top-0 left-0 right-0 flex flex-col items-center justify-center bg-white shadow-md py-4 z-10">
        <div className="flex flex-row items-center">
          <img
            src="/logoAi.png"
            alt="Logo"
            className="h-10 w-10 mr-2 rounded-lg bg-contain"
          />
          <span className="text-xl font-bold">SpotFind</span>
        </div>
        <div className="mt-2 text-sm font-medium">
          Discover Music Tailored to Your Taste by Language and Artist
        </div>
      </div>
      <div className="pb-[200px] pt-4 md:pt-10 mt-20">
        <ChatList messages={messages} />
        <ChatScrollAnchor />
      </div>
      <div
        className="fixed inset-x-0 bottom-0 w-full bg-gradient-to-b
    from-muted/50 via-muted/30 to-50% peer-[[data-state=open]]:group-[]:lg:pl-[250px] peer-[[data-state=open]]:group-[]:xl:pl-300px"
      >
